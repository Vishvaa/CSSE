...
# Happy Path tests
    ...
    def test_200_040_ShouldcalculateAltitudewithBlankHorizon(self):
        param = {'observation': '45d15.2', 'op': 'adjust','horizon':'artifical', 'height':'', 'pressure':'','temperature':''}
        expectedparam = {'altitude': '45d14.3', 'observation': '45d15.2', 'op': 'adjust','horizon':'artifical','height':'', 'pressure':'','temperature':''}
